...
- README: centered header with Fluent Emoji trident logo, status badges, and image credit

## [0.1.2] - 2026-08-28

### Changed

- Simplify `<AsyncSwitch>` by merging duplicate loading/error/empty render branches into a single switch
